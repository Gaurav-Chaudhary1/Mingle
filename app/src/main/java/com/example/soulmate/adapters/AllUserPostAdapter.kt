...
class AllUserPostAdapter(private val posts: List<Post>) :
    RecyclerView.Adapter<AllUserPostAdapter.AllPostViewHolder>() {
    ...
    inner class AllPostViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(post: Post) {
            ...
            itemView.setOnClickListener {
                ...
                val intent = Intent(context, NextUserProfile::class.java).apply {
                    putExtra("otherUserUID", post.userUID)
                }
